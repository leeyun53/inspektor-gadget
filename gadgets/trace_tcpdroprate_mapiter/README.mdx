...
The trace_tcpdroprate gadget tracks TCP kernel-dropped packets/segments.
...
<Tabs groupId="env">
    <TabItem value="kubectl-gadget" label="kubectl gadget">
        ```bash
        $ kubectl gadget run ghcr.io/inspektor-gadget/gadget/trace_tcpdroprate:%IG_TAG% [flags]
        ```
    </TabItem>

    <TabItem value="ig" label="ig">
        ```bash
        $ sudo ig run ghcr.io/inspektor-gadget/gadget/trace_tcpdroprate:%IG_TAG% [flags]
        ```
    </TabItem>
</Tabs>
...
<Tabs groupId="env">
    <TabItem value="kubectl-gadget" label="kubectl gadget">
        ...
        ```bash
        $ kubectl gadget run trace_tcpdroprate:%IG_TAG%
    ...
    <TabItem value="ig" label="ig">
        ...
        ```bash
        $ sudo ig run trace_tcpdroprate:%IG_TAG% --containername test-trace-tcpdrop
